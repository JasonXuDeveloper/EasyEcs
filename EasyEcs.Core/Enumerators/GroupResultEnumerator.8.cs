    ...
    where T8 : struct
{
    ...
    private GroupResultEnumerator(Entity[] entities, T1[] components1, T2[] components2, T3[] components3,
        T4[] components4, T5[] components5, T6[] components6, T7[] components7, T8[] components8, Tag tag, int groupIdx,
    ...
    public GroupResultEnumerator<T1, T2, T3, T4, T5, T6, T7, T8> GetEnumerator() =>
        new(_entities, _components1, _components2, _components3, _components4, _components5, _components6, _components7,
            _components8, _tag, _groupIdx, _elementIdx, _contextGroups);
    ...
    public bool MoveNext()
    {
        ...
        while (_groupIdx < _groups.Count)
        {
            ...
            {
                Current = new GroupResult<T1, T2, T3, T4, T5, T6, T7, T8>(group[_elementIdx], _entities, _components1,
                    _components2, _components3, _components4, _components5, _components6, _components7, _components8);
                _elementIdx++;
                return true;
            }
