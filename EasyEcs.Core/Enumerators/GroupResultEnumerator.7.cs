    ...
    where T7 : struct, IComponent
{
    ...
    {
        if (_matchingArchetypes == null || _components1 == null || _components2 == null || _components3 == null || _components4 == null || _components5 == null || _components6 == null || _components7 == null)
            return false;
        ...
        while (_archetypeIndex < _matchingArchetypes.Count)
        {
            ...
            while (_entityIndexInArchetype < entitySpan.Length)
            {
                ...
                Current = new GroupResult<T1, T2, T3, T4, T5, T6, T7>(entityId, _entities, _components1, _components2, _components3, _components4, _components5, _components6, _components7);
                return true;
            }
