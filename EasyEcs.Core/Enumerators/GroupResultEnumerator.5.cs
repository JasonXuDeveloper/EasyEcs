...
public struct GroupResultEnumerator<T1, T2, T3, T4, T5> : IDisposable
    where T1 : struct
    where T2 : struct
    where T3 : struct
    where T4 : struct
    where T5 : struct
{
    ...
    public GroupResult<T1, T2, T3, T4, T5> Current { get; private set; }
    ...
    private GroupResultEnumerator(Entity[] entities, T1[] components1, T2[] components2, T3[] components3,
        T4[] components4, T5[] components5, Tag tag, int groupIdx, int elementIdx,
    ...
    public GroupResultEnumerator<T1, T2, T3, T4, T5> GetEnumerator() =>
        new(_entities, _components1, _components2, _components3, _components4, _components5, _tag, _groupIdx,
            _elementIdx, _contextGroups);
    ...
    public bool MoveNext()
    {
        ...
        while (_groupIdx < _groups.Count)
        {
            ...
            {
                Current = new GroupResult<T1, T2, T3, T4, T5>(group[_elementIdx], _entities, _components1, _components2,
