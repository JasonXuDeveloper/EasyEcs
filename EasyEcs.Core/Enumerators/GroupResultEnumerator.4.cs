    ...
    where T4 : struct
{
    ...
    private GroupResultEnumerator(Entity[] entities, T1[] components1, T2[] components2, T3[] components3,
        T4[] components4, Tag tag, int groupIdx, int elementIdx, SortedDictionary<Tag, List<int>> contextGroups)
    {
        _entities = entities;
    ...
    public GroupResultEnumerator<T1, T2, T3, T4> GetEnumerator() =>
        new(_entities, _components1, _components2, _components3, _components4, _tag, _groupIdx, _elementIdx,
            _contextGroups);
    ...
    public bool MoveNext()
    {
        ...
        while (_groupIdx < _groups.Count)
        {
            ...
            {
                Current = new GroupResult<T1, T2, T3, T4>(group[_elementIdx], _entities, _components1, _components2,
