...
public struct GroupResultEnumerator<T1, T2, T3, T4, T5, T6> : IDisposable
    where T1 : struct
    where T2 : struct
    where T3 : struct
    where T4 : struct
    ...
    where T6 : struct
{
    ...
    private GroupResultEnumerator(Entity[] entities, T1[] components1, T2[] components2, T3[] components3,
        T4[] components4, T5[] components5, T6[] components6, Tag tag, int groupIdx, int elementIdx,
        SortedDictionary<Tag, List<int>> contextGroups)
    {
        _entities = entities;
    ...
    public GroupResultEnumerator<T1, T2, T3, T4, T5, T6> GetEnumerator() =>
        new(_entities, _components1, _components2, _components3, _components4, _components5, _components6, _tag,
            _groupIdx, _elementIdx, _contextGroups);
    ...
    public bool MoveNext()
    {
        ...
        while (_groupIdx < _groups.Count)
        {
            ...
            {
                Current = new GroupResult<T1, T2, T3, T4, T5, T6>(group[_elementIdx], _entities, _components1,
                    _components2, _components3, _components4, _components5, _components6);
                _elementIdx++;
                return true;
            }
