...
public readonly struct GroupResult<T1>
{
    ...
    public ref T1 Component1 => ref Unsafe.As<T1[]>(_context.Components[_bitIdx1])[_entityId];
...
public readonly struct GroupResult<T1, T2>
{
    ...
    public ref T2 Component2 => ref Unsafe.As<T2[]>(_context.Components[_bitIdx2])[_entityId];
...
public readonly struct GroupResult<T1, T2, T3>
{
    ...
    public ref T3 Component3 => ref Unsafe.As<T3[]>(_context.Components[_bitIdx3])[_entityId];
...
public readonly struct GroupResult<T1, T2, T3, T4>
{
    ...
    public ref T4 Component4 => ref Unsafe.As<T4[]>(_context.Components[_bitIdx4])[_entityId];
...
public readonly struct GroupResult<T1, T2, T3, T4, T5>
{
    ...
    public ref T5 Component5 => ref Unsafe.As<T5[]>(_context.Components[_bitIdx5])[_entityId];
...
public readonly struct GroupResult<T1, T2, T3, T4, T5, T6>
{
    ...
    public ref T6 Component6 => ref Unsafe.As<T6[]>(_context.Components[_bitIdx6])[_entityId];
...
public readonly struct GroupResult<T1, T2, T3, T4, T5, T6, T7>
{
    ...
    public ref T7 Component7 => ref Unsafe.As<T7[]>(_context.Components[_bitIdx7])[_entityId];

    public GroupResult(int id, Context context, int bitIdx1, int bitIdx2, int bitIdx3, int bitIdx4, int bitIdx5,
        int bitIdx6, int bitIdx7)
    {
        _entityId = id;
        _context = context;
        _bitIdx1 = bitIdx1;
...
public readonly struct GroupResult<T1, T2, T3, T4, T5, T6, T7, T8>
{
    ...
    public ref T8 Component8 => ref Unsafe.As<T8[]>(_context.Components[_bitIdx8])[_entityId];

    public GroupResult(int id, Context context, int bitIdx1, int bitIdx2, int bitIdx3, int bitIdx4, int bitIdx5,
        int bitIdx6, int bitIdx7, int bitIdx8)
    {
        _entityId = id;
        _context = context;
        _bitIdx1 = bitIdx1;
...
public readonly struct GroupResult<T1, T2, T3, T4, T5, T6, T7, T8, T9>
{
    ...
    public ref T9 Component9 => ref Unsafe.As<T9[]>(_context.Components[_bitIdx9])[_entityId];

    public GroupResult(int id, Context context, int bitIdx1, int bitIdx2, int bitIdx3, int bitIdx4, int bitIdx5,
        int bitIdx6, int bitIdx7, int bitIdx8, int bitIdx9)
    {
        _entityId = id;
        _context = context;
        _bitIdx1 = bitIdx1;
